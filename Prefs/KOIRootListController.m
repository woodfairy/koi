...
- (instancetype)init {
    ...
    if (self) {
        KOIAppearanceSettings* appearanceSettings = [[KOIAppearanceSettings alloc] init];
        self.hb_appearanceSettings = appearanceSettings;
        self.enableSwitch = [[UISwitch alloc] init];
        self.enableSwitch.onTintColor = [UIColor colorWithRed: 0.44 green: 0.73 blue: 0.62 alpha: 1.00];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/KoiPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/KoiPrefs.bundle/Banner.png"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed: 0.59 green: 0.93 blue: 0.76 alpha: 1.00];
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Koi.disabled"]) return;
    [[self enableSwitch] setEnabled:NO];

    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Koi"
	message:@"Koi Preferences disabled due to Koi being disabled with iCleaner Pro"
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Koi"
